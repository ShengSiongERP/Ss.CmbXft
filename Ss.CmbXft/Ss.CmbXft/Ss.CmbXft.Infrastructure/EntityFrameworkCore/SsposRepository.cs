...
/// </summary>
public class SsposRepository<TEntity, TKey> : ISsposRepository<TEntity, TKey> where TEntity : class
{
    protected readonly SsposDbContext _context;
    protected readonly DbSet<TEntity> _dbSet;

    public SsposRepository(SsposDbContext dbContext)
    {
